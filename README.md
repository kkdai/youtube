...
[![Go Reference](https://pkg.go.dev/badge/github.com/kkdai/youtube.svg)](https://pkg.go.dev/github.com/takefy-dev/youtube)
...
```shell
go get github.com/takefy-dev/youtube
```
 ...
 * ### Get information of dotGo-2015-rob-pike video for downloading
    ...
    `go get github.com/takefy-dev/youtube/youtubedr`
